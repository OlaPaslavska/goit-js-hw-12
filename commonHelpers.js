...
</li>`).join("");u.gallery.insertAdjacentHTML("beforeend",r)}function B(){u.loader.classList.remove("hidden")}function m(){u.loader.classList.add("hidden")}function b(){u.loadMoreBtn.classList.remove("hidden")}function g(){u.loadMoreBtn.classList.add("hidden")}function S(t,r){t>=r?(g(),r&&n.info({title:"The end!",message:"We're sorry, but you've reached the end of search results."})):b()}const a={form:document.querySelector(".form"),input:document.querySelector(".input"),button:document.querySelector("button"),gallery:document.querySelector(".gallery"),loader:document.querySelector(".loader"),loadMoreBtn:document.querySelector(".load-more-btn")};let d="",i=1,p=15,l=1;const h=new M(".gallery a",{captions:!0,captionsData:"alt",captionDelay:250});a.form.addEventListener("submit",async t=>{if(t.preventDefault(),d=a.input.value.trim(),i=1,d===""){a.gallery.innerHTML=" ",n.warning({title:"Warning",message:"Please, enter the query.",backgroundColor:"#ef4040",layout:2,position:"topRight",displayMode:"once"}),a.form.reset();return}B(),a.gallery.innerHTML=" ";try{const r=await L(d,i,p);if(l=Math.ceil(r.totalHits/p),l===0){n.error({message:"Sorry, there are no images matching your search query. Please try again!",layout:2,displayMode:"once",backgroundColor:"#ef4040",progressBarColor:"#B51B1B",position:"topRight"}),a.form.reset(),m();return}m(),a.form.reset(),f(r.hits),h.refresh(),b()}catch(r){n.error({title:"Error",message:`${r}`,layout:2,displayMode:"once",backgroundColor:"#ef4040",progressBarColor:"#B51B1B",position:"topRight"})}});a.loadMoreBtn.addEventListener("click",async()=>{g(),B(),i++;try{const t=await L(d,i,p);if(l=Math.ceil(t.totalHits/p),t.hits.length==0||i>=l){f(t.hits),h.refresh(),m(),n.info({title:"Info",message:"We're sorry, but you've reached the end of search results.",position:"topCenter",timeout:5e3}),g();return}f(t.hits),h.refresh(),m(),i<l&&b(),S(i,l)}catch(t){a.gallery.innerHTML=" ",n.error({title:"Error",message:`${t}`,layout:2,displayMode:"once",backgroundColor:"#ef4040",progressBarColor:"#B51B1B",position:"topRight"})}});
